...
export class FilterPaginationTableComponent implements OnInit {
  ...
  onbtnCLicked() {
    this.view1Json = this.appService.view1JSON;
    this.view2Json = this.appService.view2JSON;
    if (this.view1Json && this.view2Json) {
      this.differences = this.compareJSON(this.view1Json, this.view2Json);
